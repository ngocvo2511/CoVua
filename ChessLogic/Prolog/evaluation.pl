...
score(Position, Color, Counter, Value) :-
    ...
    % Evaluate special conditions first
    score_special(Position, Color, Counter, ValueSpecial),
...
% Game result values - always from the perspective of the color being evaluated
